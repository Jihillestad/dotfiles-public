...
-- File: ~/repos/github.com/jihillestad/dotfiles/nvim/lua/plugins/render-markdown.lua
-- About: Configures how Markdown files are rendered in Neovim, including syntax
-- highlighting and preview capabilities.
-- Credits: A special thanks to linkarzu for providing dorfiles for me to
-- scavenge.
