-- =============================================================================
-- Title: noice.lua
-- File: ~/repos/github.com/jihillestad/dotfiles/nvim/lua/plugins/noice.lua
-- About: This file configures the noice.nvim plugin to be nicer and less
-- Credits: A special thanks to linkarzu for providing this in his dotfiles for
-- me to scavenge. This helped me to make searching and info more centered.
-- Sources:
-- - http://github.com/folke/noice.nvim
