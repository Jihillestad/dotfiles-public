-- =============================================================================
-- Title: nvim-lint.lua
-- File: ~/repos/github.com/jihillestad/dotfiles/nvim/lua/plugins/nvim-lint.lua
-- About: Some overrides are needed for linting to work for my workflow. This
...
local cfg_path = os.getenv("HOME") .. "/repos/github.com/jihillestad/dotfiles/.markdownlint.yaml"
