-- =============================================================================
-- Title: blink-cmp.lua
-- File: ~/repos/github.com/jihillestad/dotfiles/nvim/lua/plugins/blink-cmp.lua
-- About: completion plugin with support for LSPs and external sources that
			...
			providers = {
				...
				dictionary = {
					...
					opts = {
						...
						-- have your .txt files
						-- TODO: Add dictionary files
						dictionary_directories = { vim.fn.expand("~/repos/github.com/jihillestad/dotfiles/dictionary") },
						-- Notice I'm also adding the words I add to the spell dictionary
						dictionary_files = {
							vim.fn.expand("~/repos/github.com/jihillestad/dotfiles/nvim/spell/en.utf-8.add"),
						},
